...
from keras.layers import Add, Concatenate, Conv2D, MaxPooling2D, UpSampling2D, ZeroPadding2D, SeparableConv2D
...
from nets.CSPdarknet53_sep import darknet_body
...
def yolo_body(inputs, num_anchors, num_classes):
    ...
    P3_output = Convolution2D(num_anchors * (num_classes + 5), (1, 1),
    ...
    P4_output = Convolution2D(num_anchors * (num_classes + 5), (1, 1),
                              kernel_initializer=keras.initializers.normal(
    ...
    P5_output = Convolution2D(num_anchors * (num_classes + 5), (1, 1),
                              kernel_initializer=keras.initializers.normal(
