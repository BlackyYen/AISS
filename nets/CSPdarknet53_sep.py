...
from keras.layers import Add, Concatenate, Conv2D, Layer, MaxPooling2D, UpSampling2D, ZeroPadding2D, SeparableConv2D
...
#---------------------------------------------------#
def Convolution2D_BN_Mish(*args, **kwargs):
    no_bias_kwargs = {'use_bias': False}
    no_bias_kwargs.update(kwargs)
    return compose(Convolution2D(*args, **no_bias_kwargs),
...
#---------------------------------------------------#
def darknet_body(x):
    x = Convolution2D_BN_Mish(32, (3, 3))(x)
